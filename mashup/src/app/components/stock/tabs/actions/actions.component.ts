...
export class ActionsComponent implements OnInit, OnChanges {
  ...
  ngOnInit(): void {
    this.colonnesContrat = [
      { id: 'commandes',        name: '',             field: 'openOrderNumber', width: 140, align: 'center',
      ...
      { id: 'status',          name: 'Statut',       field: 'status',          width: 150, sortable: true, align: 'center', filterType: 'text',
      ...
      { id: 'deliveredQuantity',name: 'Qté livrée',  field: 'deliveredQuantity',width: 120, sortable: true, align: 'center', filterType: 'text',
        formatter: (_r: number, _c: number, v: string) => this.fmtQty(v) },
{ id: 'differenceQty',   name: 'Reste à commander',   field: 'contractQuantity',width: 140, sortable: true, align: 'center', filterType: 'text',
