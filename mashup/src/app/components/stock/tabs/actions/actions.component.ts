...
export class ActionsComponent implements OnInit, OnChanges {
  ...
  ngOnInit(): void {
    this.colonnesContrat = [
      ...
      { id: 'customerCode',    name: 'Client',       field: 'customerCode',    width: 100, sortable: true, align: 'center', filterType: 'text' },
      ...
      { id: 'lineStatus',      name: 'Statut ligne', field: 'lineStatus',      width: 110, sortable: true, align: 'center', filterType: 'text' },
